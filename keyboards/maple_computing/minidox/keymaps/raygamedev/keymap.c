...
[_QWERTY] = LAYOUT_split_3x5_3(
  ...
  LSFT_T(KC_Z),    KC_X,    KC_C,    KC_V,    KC_B,         KC_N,    KC_M,    KC_COMM, KC_DOT,  LSFT_T(KC_SLSH),
                    KC_LCTL, LGUI_T(KC_ESC), LT(LOWER, KC_SPC),         LT(RAISE, KC_BSPC), LT(ADJUST,KC_ENT), OSM(MOD_LSFT)),
...
[_RAISE] = LAYOUT_split_3x5_3(
  LGUI(KC_GRV),    KC_2,    KC_3,    KC_4,    KC_5,         KC_6,    KC_7,    KC_8,    KC_9,    KC_0,
  KC_TAB,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,    KC_LEFT, KC_DOWN, KC_UP,  KC_RIGHT, KC_RBRC,
...
[_LOWER] = LAYOUT_split_3x5_3(
  ...
  KC_LSFT, KC_7, KC_8, KC_9, _______,      KC_HASH, KC_DLR, KC_AMPR, KC_PIPE,  KC_PERC,
              KC_0, _______, _______,      KC_BSPC,  _______, KC_DEL
),
...
[_ADJUST] =  LAYOUT_split_3x5_3(
  ...
  KC_F11,  KC_F12,  KC_1, _______, _______,      _______, _______, _______, TSKMGR, CALTDEL,
